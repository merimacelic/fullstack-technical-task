...
/// <param name="Statuses">Optional status filter; tasks matching any of the listed statuses are returned. Allowed values: <c>Pending</c>, <c>InProgress</c>, <c>Completed</c>.</param>
/// <param name="Priorities">Optional priority filter; tasks matching any of the listed priorities are returned. Allowed values: <c>Low</c>, <c>Medium</c>, <c>High</c>, <c>Critical</c>.</param>
/// <param name="Search">Optional substring match against title and description. LIKE wildcards are escaped.</param>
/// <param name="TagIds">Optional tag filter; tasks carrying any of the listed tag ids are returned.</param>
